            ...
            <section id="reserve-ritual" className="py-16 md:py-24 bg-zinc-950 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 relative z-10">
                    <ScrollReveal className="text-center mb-12">
                        <p className="text-moss-100 uppercase tracking-[0.5em] text-[12px] font-black mb-6 italic">Secure Your Appointment</p>
                        <h2 className="text-3xl md:text-4xl font-serif text-white mb-6 tracking-tighter">Reserve Your Ritual</h2>
                        <p className="text-white/60 font-serif italic mb-6 max-w-xl mx-auto text-sm">After confirming your reservation, please screenshot your reference code. Present it to our team upon arrival to receive your bespoke service.</p>
